...
func (value NotifyReportRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyReportRequestCustomData) UnmarshalJSON(data []byte) error {
	return customdata.Unmarshal(data, &value.VendorID, &value.Extra)
}

func (NotifyReportRequest) ActionName() string { return "NotifyReport" }

func (NotifyReportRequest) Version() protocol.Version { return protocol.OCPP201 }
