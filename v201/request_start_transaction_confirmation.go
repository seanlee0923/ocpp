...
func (value RequestStartTransactionConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *RequestStartTransactionConfirmationCustomData) UnmarshalJSON(data []byte) error {
