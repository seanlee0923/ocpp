...
func (value GetInstalledCertificateIdsConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *GetInstalledCertificateIdsConfirmationCustomData) UnmarshalJSON(data []byte) error {
