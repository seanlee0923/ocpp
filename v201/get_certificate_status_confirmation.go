...
func (value GetCertificateStatusConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *GetCertificateStatusConfirmationCustomData) UnmarshalJSON(data []byte) error {
