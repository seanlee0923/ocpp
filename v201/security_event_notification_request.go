...
func (value SecurityEventNotificationRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *SecurityEventNotificationRequestCustomData) UnmarshalJSON(data []byte) error {
	return customdata.Unmarshal(data, &value.VendorID, &value.Extra)
}

func (SecurityEventNotificationRequest) ActionName() string { return "SecurityEventNotification" }

func (SecurityEventNotificationRequest) Version() protocol.Version { return protocol.OCPP201 }
