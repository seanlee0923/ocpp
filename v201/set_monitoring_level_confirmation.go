...
func (value SetMonitoringLevelConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *SetMonitoringLevelConfirmationCustomData) UnmarshalJSON(data []byte) error {
