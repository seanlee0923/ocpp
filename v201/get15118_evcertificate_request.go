...
var schemaGet15118EVCertificateRequest = &validation.Schema{Type: "object", Properties: map[string]*validation.Schema{"customData": &validation.Schema{Type: "object", Properties: map[string]*validation.Schema{"vendorId": &validation.Schema{Type: "string", AllowAdditional: true, MaxLength: 255, HasMaxLength: true}}, Required: []string{"vendorId"}, AllowAdditional: true}, "iso15118SchemaVersion": &validation.Schema{Type: "string", AllowAdditional: true, MaxLength: 50, HasMaxLength: true}, "action": &validation.Schema{Type: "string", Enum: []string{"Install", "Update"}}, "exiRequest": &validation.Schema{Type: "string", AllowAdditional: true, MaxLength: 5600, HasMaxLength: true}}, Required: []string{"iso15118SchemaVersion", "action", "exiRequest"}}
...
func (value Get15118EVCertificateRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *Get15118EVCertificateRequestCustomData) UnmarshalJSON(data []byte) error {
	return customdata.Unmarshal(data, &value.VendorID, &value.Extra)
}

func (Get15118EVCertificateRequest) ActionName() string { return "Get15118EVCertificate" }

func (Get15118EVCertificateRequest) Version() protocol.Version { return protocol.OCPP201 }
