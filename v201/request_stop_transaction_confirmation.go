...
func (value RequestStopTransactionConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *RequestStopTransactionConfirmationCustomData) UnmarshalJSON(data []byte) error {
