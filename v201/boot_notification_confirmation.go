...
func (value BootNotificationConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *BootNotificationConfirmationCustomData) UnmarshalJSON(data []byte) error {
