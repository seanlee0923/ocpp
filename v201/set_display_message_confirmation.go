...
func (value SetDisplayMessageConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *SetDisplayMessageConfirmationCustomData) UnmarshalJSON(data []byte) error {
