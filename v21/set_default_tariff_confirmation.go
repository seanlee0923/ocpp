...
func (value SetDefaultTariffConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *SetDefaultTariffConfirmationCustomData) UnmarshalJSON(data []byte) error {
