...
func (value ClosePeriodicEventStreamConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *ClosePeriodicEventStreamConfirmationCustomData) UnmarshalJSON(data []byte) error {
