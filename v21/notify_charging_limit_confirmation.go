...
func (value NotifyChargingLimitConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyChargingLimitConfirmationCustomData) UnmarshalJSON(data []byte) error {
	return customdata.Unmarshal(data, &value.VendorID, &value.Extra)
}

func (NotifyChargingLimitConfirmation) ActionName() string { return "NotifyChargingLimit" }

func (NotifyChargingLimitConfirmation) Version() protocol.Version { return protocol.OCPP21 }
