...
func (value NotifyMonitoringReportConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyMonitoringReportConfirmationCustomData) UnmarshalJSON(data []byte) error {
	return customdata.Unmarshal(data, &value.VendorID, &value.Extra)
}

func (NotifyMonitoringReportConfirmation) ActionName() string { return "NotifyMonitoringReport" }

func (NotifyMonitoringReportConfirmation) Version() protocol.Version { return protocol.OCPP21 }
