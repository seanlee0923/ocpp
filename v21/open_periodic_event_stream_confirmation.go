...
func (value OpenPeriodicEventStreamConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *OpenPeriodicEventStreamConfirmationCustomData) UnmarshalJSON(data []byte) error {
