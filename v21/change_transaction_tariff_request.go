...
func (value ChangeTransactionTariffRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *ChangeTransactionTariffRequestCustomData) UnmarshalJSON(data []byte) error {
