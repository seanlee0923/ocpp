...
func (value NotifyAllowedEnergyTransferConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyAllowedEnergyTransferConfirmationCustomData) UnmarshalJSON(data []byte) error {
