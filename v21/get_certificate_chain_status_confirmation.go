...
func (value GetCertificateChainStatusConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *GetCertificateChainStatusConfirmationCustomData) UnmarshalJSON(data []byte) error {
