...
func (value AdjustPeriodicEventStreamRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *AdjustPeriodicEventStreamRequestCustomData) UnmarshalJSON(data []byte) error {
