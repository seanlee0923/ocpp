...
func (value NotifyPriorityChargingRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyPriorityChargingRequestCustomData) UnmarshalJSON(data []byte) error {
