...
func (value NotifyPeriodicEventStreamRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyPeriodicEventStreamRequestCustomData) UnmarshalJSON(data []byte) error {
