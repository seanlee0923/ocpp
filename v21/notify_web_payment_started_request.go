...
func (value NotifyWebPaymentStartedRequestCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyWebPaymentStartedRequestCustomData) UnmarshalJSON(data []byte) error {
