...
func (value ClearVariableMonitoringConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *ClearVariableMonitoringConfirmationCustomData) UnmarshalJSON(data []byte) error {
