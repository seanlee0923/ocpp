...
func (value NotifyEVChargingScheduleConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *NotifyEVChargingScheduleConfirmationCustomData) UnmarshalJSON(data []byte) error {
