...
func (value RequestBatterySwapConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *RequestBatterySwapConfirmationCustomData) UnmarshalJSON(data []byte) error {
