...
func (value UpdateDynamicScheduleConfirmationCustomData) MarshalJSON() ([]byte, error) {
	return customdata.Marshal(value.VendorID, value.Extra)
}

func (value *UpdateDynamicScheduleConfirmationCustomData) UnmarshalJSON(data []byte) error {
