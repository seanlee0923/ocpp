...
CSMS 방향 convenience call에는 Reset, RemoteStartTransaction, RemoteStopTransaction,
ChangeAvailability, UnlockConnector, TriggerMessage와 DataTransfer가 있다. 나머지 생성 Action도
