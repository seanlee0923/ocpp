...
CSMS-directed convenience calls include Reset, RemoteStartTransaction,
RemoteStopTransaction, ChangeAvailability, UnlockConnector,
TriggerMessage, and DataTransfer. Any other generated Action can also be
